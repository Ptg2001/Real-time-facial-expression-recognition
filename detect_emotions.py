...
emotion_model_path = 'models/cnn.hdf5'  # pre-trained model
...
while True:
    ...
    if len(faces) > 0:
        ...
        # Extract the facial key point of the face from the grayscale image, resize it to a fixed 64x64 pixels(
        # pre-trained model shape) the facial for classification via the CNN
